...
TEST(TestStateMachine, TestNestedDispatch)
{
    ...
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mEntered == 0);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mExited == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mLogged == 0);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mEntered == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mExited == 0);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mLogged == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms3.mEntered == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms3.mExited == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms3.mLogged == 1);
}
...
TEST(TestStateMachine, TestMethodExec)
{
    ...
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mExited == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mLogged == 0);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mPrevious == nullptr);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mEntered == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mExited == 0);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mLogged == 1);
    EXPECT_TRUE(strcmp(fsm.mTransitions.mFactory.ms2.mPrevious, "State1") == 0);
    // transition back to State1
    fsm.mStateMachine.Dispatch(Event::Create<Event1>());
    EXPECT_TRUE(fsm.mStateMachine.GetState().Is<State1>());
    // verify expected method calls
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mEntered == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mExited == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms1.mLogged == 1);
    EXPECT_TRUE(strcmp(fsm.mTransitions.mFactory.ms1.mPrevious, "State2") == 0);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mEntered == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mExited == 1);
    EXPECT_TRUE(fsm.mTransitions.mFactory.ms2.mLogged == 1);
    EXPECT_TRUE(strcmp(fsm.mTransitions.mFactory.ms2.mPrevious, "State1") == 0);
}
