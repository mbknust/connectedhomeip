                                         ...
                                         BitFlags<AdditionalDataFields> additionalDataFields, char * additionalDataPayloadOutput)
{
    ...
    {
        EXPECT_TRUE(!bufferHandle.IsNull());
    }
    else
    {
        return err;
...
TEST_F(TestAdditionalDataPayload, TestGeneratingAdditionalDataPayloadWithoutRotatingDeviceId)
{
    ...
    EXPECT_TRUE(GenerateAdditionalDataPayload(additionalDataPayloadParams, additionalDataFields, output) == CHIP_NO_ERROR);
    EXPECT_TRUE(strcmp(output, kAdditionalDataPayloadWithoutRotatingDeviceId) == 0);
}
...
TEST_F(TestAdditionalDataPayload, TestGeneratingAdditionalDataPayloadWithRotatingDeviceId)
{
    ...
    char output[kAdditionalDataPayloadLength];
    EXPECT_TRUE(GenerateAdditionalDataPayload(additionalDataPayloadParams, additionalDataFields, output) == CHIP_NO_ERROR);
    EXPECT_TRUE(strcmp(output, kAdditionalDataPayloadWithRotatingDeviceId) == 0);
}
...
TEST_F(TestAdditionalDataPayload, TestGeneratingAdditionalDataPayloadWithRotatingDeviceIdAndMaxLifetimeCounter)
{
    ...
    char output[kAdditionalDataPayloadLength];
    EXPECT_TRUE(GenerateAdditionalDataPayload(additionalDataPayloadParams, additionalDataFields, output) == CHIP_NO_ERROR);
    EXPECT_TRUE(strcmp(output, kAdditionalDataPayloadWithRotatingDeviceIdAndMaxLifetimeCounter) == 0);
}
...
TEST_F(TestAdditionalDataPayload, TestGeneratingAdditionalDataPayloadWithRotatingDeviceIdWithNullInputs)
{
    ...
    char output[kAdditionalDataPayloadLength];
    EXPECT_TRUE(GenerateAdditionalDataPayload(additionalDataPayloadParams, additionalDataFields, output) ==
...
TEST_F(TestAdditionalDataPayload, TestGeneratingRotatingDeviceIdAsString)
{
    ...
    EXPECT_TRUE(strcmp(rotatingDeviceIdHexBuffer, kRotatingDeviceId) == 0);
    ...
    EXPECT_TRUE(lifetimeCounter == kLifetimeCounter);
}
...
TEST_F(TestAdditionalDataPayload, TestParsingAdditionalDataPayloadWithRotatingDeviceId)
{
    ...
    EXPECT_TRUE(ParseAdditionalDataPayload(kAdditionalDataPayloadWithRotatingDeviceId,
                                           strlen(kAdditionalDataPayloadWithRotatingDeviceId), resultPayload) == CHIP_NO_ERROR);
    EXPECT_TRUE(strcmp(resultPayload.rotatingDeviceId.c_str(), kRotatingDeviceId) == 0);
}

TEST_F(TestAdditionalDataPayload, TestParsingAdditionalDataPayloadWithoutRotatingDeviceId)
{
    chip::SetupPayloadData::AdditionalDataPayload resultPayload;
    EXPECT_TRUE(ParseAdditionalDataPayload(kAdditionalDataPayloadWithoutRotatingDeviceId,
                                           strlen(kAdditionalDataPayloadWithoutRotatingDeviceId), resultPayload) == CHIP_NO_ERROR);
    EXPECT_TRUE(strcmp(resultPayload.rotatingDeviceId.c_str(), "") == 0);
}

TEST_F(TestAdditionalDataPayload, TestParsingAdditionalDataPayloadWithInvalidRotatingDeviceIdLength)
{
    chip::SetupPayloadData::AdditionalDataPayload resultPayload;
    EXPECT_TRUE(ParseAdditionalDataPayload(kAdditionalDataPayloadWithInvalidRotatingDeviceIdLength,
...
{
    chip::SetupPayloadData::AdditionalDataPayload resultPayload;
    EXPECT_TRUE(ParseAdditionalDataPayload(kAdditionalDataPayloadWithLongRotatingDeviceId,
...
{
    chip::SetupPayloadData::AdditionalDataPayload resultPayload;
    EXPECT_TRUE(ParseAdditionalDataPayload(kAdditionalDataPayloadWithShortRotatingDeviceId,
                                           strlen(kAdditionalDataPayloadWithShortRotatingDeviceId),
                                           resultPayload) == CHIP_NO_ERROR);
    EXPECT_TRUE(strcmp(resultPayload.rotatingDeviceId.c_str(), kShortRotatingDeviceId) == 0);
}
