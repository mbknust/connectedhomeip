...
TEST(EventPathParams, TestSamePath)
{
...
TEST(EventPathParams, TestDifferentEndpointId)
{
    EventPathParams eventPathParams1(2, 3, 4);
...
TEST(EventPathParams, TestDifferentClusterId)
{
    EventPathParams eventPathParams1(2, 3, 4);
...
TEST(EventPathParams, TestDifferentEventId)
{
    EventPathParams eventPathParams1(2, 3, 4);
