...
TEST(TestTestEventTriggerDelegate, TestKeyChecking)
{
    ...
    EXPECT_EQ(delegate.DoesEnableKeyMatch(ByteSpan{ kTestKey }), true);
    EXPECT_EQ(delegate.DoesEnableKeyMatch(ByteSpan{ kBadKey }), false);
    EXPECT_EQ(delegate.DoesEnableKeyMatch(ByteSpan{ kDiffLenBadKey }), false);
    EXPECT_EQ(delegate.DoesEnableKeyMatch(ByteSpan{}), false);
}
