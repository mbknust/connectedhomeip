...
TEST_F(TestPath, TestAttributePathIntersect)
{
...
TEST_F(TestPath, TestAttributePathIncludedSameFieldId)
{
...
TEST_F(TestPath, TestAttributePathIncludedDifferentFieldId)
{
    {
        AttributePathParams clusterInfo1;
        AttributePathParams clusterInfo2;
...
TEST_F(TestPath, TestAttributePathIncludedDifferentEndpointId)
{
    AttributePathParams clusterInfo1;
    AttributePathParams clusterInfo2;
...
TEST_F(TestPath, TestAttributePathIncludedDifferentClusterId)
{
    AttributePathParams clusterInfo1;
    AttributePathParams clusterInfo2;
...
TEST_F(TestPath, TestEventPathSameEventId)
{
...
TEST_F(TestPath, TestEventPathDifferentEventId)
{
...
TEST_F(TestPath, TestEventPathDifferentClusterId)
{
...
TEST_F(TestPath, TestEventPathDifferentEndpointId)
{
