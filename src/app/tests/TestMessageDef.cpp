...
void ParseInvokeRequestMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_EQ(suppressResponse, true);
    EXPECT_EQ(timedRequest, true);
#if CHIP_CONFIG_IM_PRETTY_PRINT
...
void ParseInvokeResponseMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_EQ(err, CHIP_NO_ERROR);
    EXPECT_EQ(moreChunkedMessages, true);
...
TEST_F(TestMessageDef, InvokeRequestMessageEndOfMessageReservationTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    InvokeRequestMessage::Builder invokeRequestMessageBuilder;
...
TEST_F(TestMessageDef, InvokeRequestsEndOfRequestReservationTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    InvokeRequestMessage::Builder invokeRequestMessageBuilder;
...
TEST_F(TestMessageDef, InvokeResponseMessageEndOfMessageReservationTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    InvokeResponseMessage::Builder invokeResponseMessageBuilder;
...
TEST_F(TestMessageDef, InvokeResponseMessageReservationForEndandMoreChunkTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    InvokeResponseMessage::Builder invokeResponseMessageBuilder;
...
TEST_F(TestMessageDef, InvokeResponsesEndOfResponseReservationTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    InvokeResponseMessage::Builder invokeResponseMessageBuilder;
