...
void ParseStatusIB(StatusIB::Parser & aStatusIBParser)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && statusIB.mStatus == chip::Protocols::InteractionModel::Status::InvalidSubscription &&
...
void ParseClusterPathIB(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && node == 1);

    err = clusterPathParser.GetEndpoint(&endpoint);
    EXPECT_TRUE(err == CHIP_NO_ERROR && endpoint == 2);

    err = clusterPathParser.GetCluster(&cluster);
    EXPECT_TRUE(err == CHIP_NO_ERROR && cluster == 3);
}
...
void BuildDataVersionFilterIB(DataVersionFilterIB::Builder & aDataVersionFilterIBBuilder)
{
    ...
    EXPECT_TRUE(clusterPathBuilder.GetError() == CHIP_NO_ERROR);
    BuildClusterPathIB(clusterPathBuilder);
    aDataVersionFilterIBBuilder.DataVersion(2).EndOfDataVersionFilterIB();
    EXPECT_TRUE(aDataVersionFilterIBBuilder.GetError() == CHIP_NO_ERROR);
}
...
void ParseDataVersionFilterIB(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && dataVersion == 2);
}
...
void BuildDataVersionFilterIBs(DataVersionFilterIBs::Builder & aDataVersionFilterIBsBuilder)
{
    ...
    EXPECT_TRUE(aDataVersionFilterIBsBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildEventFilterIB(EventFilterIB::Builder & aEventFilterIBBuilder)
{
    ...
    EXPECT_TRUE(aEventFilterIBBuilder.GetError() == CHIP_NO_ERROR);
}
...
void ParseEventFilterIB(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && eventMin == 2);
}
...
void BuildEventFilters(EventFilterIBs::Builder & aEventFiltersBuilder)
{
    ...
    EXPECT_TRUE(aEventFiltersBuilder.GetError() == CHIP_NO_ERROR);
...
void ParseAttributePathIB(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && enableTagCompression == false);
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && attribute == 4);

    err = attributePathParser.GetListIndex(&listIndex);
    EXPECT_TRUE(err == CHIP_NO_ERROR && listIndex == 5);
}
...
void BuildAttributePathList(AttributePathIBs::Builder & aAttributePathListBuilder)
{
    ...
    EXPECT_TRUE(attributePathBuilder.GetError() == CHIP_NO_ERROR);
    BuildAttributePathIB(attributePathBuilder);

    aAttributePathListBuilder.EndOfAttributePathIBs();
    EXPECT_TRUE(aAttributePathListBuilder.GetError() == CHIP_NO_ERROR);
}
...
void ParseEventPath(EventPathIB::Parser & aEventPathParser)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && event == 4);

    err = aEventPathParser.GetIsUrgent(&isUrgent);
    EXPECT_TRUE(err == CHIP_NO_ERROR && isUrgent == true);
}
...
void BuildEventPaths(EventPathIBs::Builder & aEventPathsBuilder)
{
    ...
    EXPECT_TRUE(eventPathBuilder.GetError() == CHIP_NO_ERROR);
    BuildEventPath(eventPathBuilder);

    aEventPathsBuilder.EndOfEventPaths();
    EXPECT_TRUE(aEventPathsBuilder.GetError() == CHIP_NO_ERROR);
}
...
void BuildCommandPath(CommandPathIB::Builder & aCommandPathBuilder)
{
    ...
    EXPECT_TRUE(aCommandPathBuilder.GetError() == CHIP_NO_ERROR);
}
...
void ParseCommandPath(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && endpointId == 1);

    err = commandPathParser.GetClusterId(&clusterId);
    EXPECT_TRUE(err == CHIP_NO_ERROR && clusterId == 3);

    err = commandPathParser.GetCommandId(&commandId);
    EXPECT_TRUE(err == CHIP_NO_ERROR && commandId == 4);
}
...
void ParseEventDataIB(EventDataIB::Parser & aEventDataIBParser)
{
...
#endif
    {
...

        {
            ...
            err = reader.Get(val);
            EXPECT_TRUE(err == CHIP_NO_ERROR && val);
...
void BuildEventStatusIB(EventStatusIB::Builder & aEventStatusIBBuilder)
{
    ...
    EXPECT_TRUE(aEventStatusIBBuilder.GetError() == CHIP_NO_ERROR);
    BuildEventPath(eventPathBuilder);

    StatusIB::Builder & statusIBBuilder = aEventStatusIBBuilder.CreateErrorStatus();
    EXPECT_TRUE(statusIBBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildEventReportIB(EventReportIB::Builder & aEventReportIBBuilder)
{
    ...
    EXPECT_TRUE(aEventReportIBBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildEventReports(EventReportIBs::Builder & aEventReportsBuilder)
{
    ...
    EXPECT_TRUE(aEventReportsBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildAttributeStatusIB(AttributeStatusIB::Builder & aAttributeStatusIBBuilder)
{
    ...
    EXPECT_TRUE(aAttributeStatusIBBuilder.GetError() == CHIP_NO_ERROR);
}
...
void BuildAttributeStatuses(AttributeStatusIBs::Builder & aAttributeStatusesBuilder)
{
    ...
    EXPECT_TRUE(aAttributeStatusesBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildAttributeDataIB(AttributeDataIB::Builder & aAttributeDataIBBuilder)
{
    ...
    EXPECT_TRUE(aAttributeDataIBBuilder.GetError() == CHIP_NO_ERROR);
    BuildAttributePathIB(attributePathBuilder);
...
void ParseAttributeDataIB(AttributeDataIB::Parser & aAttributeDataIBParser)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && version == 2);
...
void BuildAttributeDataIBs(AttributeDataIBs::Builder & aAttributeDataIBsBuilder)
{
    ...
    EXPECT_TRUE(aAttributeDataIBsBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildAttributeReportIB(AttributeReportIB::Builder & aAttributeReportIBBuilder)
{
    ...
    EXPECT_TRUE(aAttributeReportIBBuilder.GetError() == CHIP_NO_ERROR);
    BuildAttributeDataIB(attributeDataIBBuilder);
...
void BuildAttributeReportIBs(AttributeReportIBs::Builder & aAttributeReportIBsBuilder)
{
    ...
    EXPECT_TRUE(aAttributeReportIBsBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildCommandDataIB(CommandDataIB::Builder & aCommandDataIBBuilder)
{
    ...
    EXPECT_TRUE(aCommandDataIBBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildCommandStatusIB(CommandStatusIB::Builder & aCommandStatusIBBuilder)
{
    ...
    EXPECT_TRUE(aCommandStatusIBBuilder.GetError() == CHIP_NO_ERROR);
    BuildCommandPath(commandPathBuilder);
...
void BuildWrongInvokeResponseIB(InvokeResponseIB::Builder & aInvokeResponseIBBuilder)
{
    ...
    EXPECT_TRUE(aInvokeResponseIBBuilder.GetError() == CHIP_NO_ERROR);
}
...
void BuildInvokeRequests(InvokeRequests::Builder & aInvokeRequestsBuilder)
{
    ...
    EXPECT_TRUE(aInvokeRequestsBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildInvokeResponses(InvokeResponseIBs::Builder & aInvokeResponsesBuilder)
{
    ...
    EXPECT_TRUE(aInvokeResponsesBuilder.GetError() == CHIP_NO_ERROR);
...
void BuildInvokeRequestMessage(chip::TLV::TLVWriter & aWriter)
{
    ...
    EXPECT_TRUE(invokeRequestsBuilder.GetError() == CHIP_NO_ERROR);
...
void ParseInvokeRequestMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(suppressResponse == true);
    EXPECT_TRUE(timedRequest == true);
#if CHIP_CONFIG_IM_PRETTY_PRINT
    invokeRequestMessageParser.PrettyPrint();
#endif
    EXPECT_TRUE(invokeRequestMessageParser.ExitContainer() == CHIP_NO_ERROR);
}
...
#endif
    EXPECT_TRUE(invokeResponseMessageParser.ExitContainer() == CHIP_NO_ERROR);
}
...
void ParseReportDataMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && suppressResponse);

    err = reportDataParser.GetSubscriptionId(&subscriptionId);
    EXPECT_TRUE(err == CHIP_NO_ERROR && subscriptionId == 2);
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && moreChunkedMessages);
    EXPECT_TRUE(reportDataParser.ExitContainer() == CHIP_NO_ERROR);
}
...
void ParseReadRequestMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && isFabricFiltered);
    EXPECT_TRUE(readRequestParser.ExitContainer() == CHIP_NO_ERROR);
}
...
void BuildWriteRequestMessage(chip::TLV::TLVWriter & aWriter)
{
    ...
    EXPECT_TRUE(writeRequestBuilder.GetError() == CHIP_NO_ERROR);
...
void ParseWriteRequestMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR && timeRequest);
...
void BuildWriteResponseMessage(chip::TLV::TLVWriter & aWriter)
{
    ...
    EXPECT_TRUE(writeResponseBuilder.GetError() == CHIP_NO_ERROR);
...
void ParseWriteResponseMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(err == CHIP_NO_ERROR);
    EXPECT_TRUE(writeResponseParser.ExitContainer() == CHIP_NO_ERROR);
}
...
void ParseSubscribeRequestMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(minIntervalFloorSeconds == 2 && err == CHIP_NO_ERROR);

    err = subscribeRequestParser.GetMaxIntervalCeilingSeconds(&maxIntervalCeilingSeconds);
    EXPECT_TRUE(maxIntervalCeilingSeconds == 3 && err == CHIP_NO_ERROR);

    err = subscribeRequestParser.GetKeepSubscriptions(&keepExistingSubscription);
    EXPECT_TRUE(keepExistingSubscription && err == CHIP_NO_ERROR);

    err = subscribeRequestParser.GetIsFabricFiltered(&isFabricFiltered);
    EXPECT_TRUE(isFabricFiltered && err == CHIP_NO_ERROR);
    EXPECT_TRUE(subscribeRequestParser.ExitContainer() == CHIP_NO_ERROR);
}
...
void BuildSubscribeResponseMessage(chip::TLV::TLVWriter & aWriter)
{
    ...
    EXPECT_TRUE(subscribeResponseBuilder.GetError() == CHIP_NO_ERROR);
...
void ParseSubscribeResponseMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(subscriptionId == 1 && err == CHIP_NO_ERROR);

    err = subscribeResponseParser.GetMaxInterval(&maxInterval);
    EXPECT_TRUE(maxInterval == 2 && err == CHIP_NO_ERROR);

    EXPECT_TRUE(subscribeResponseParser.ExitContainer() == CHIP_NO_ERROR);
}
...
void BuildTimedRequestMessage(chip::TLV::TLVWriter & aWriter)
{
    ...
    EXPECT_TRUE(TimedRequestMessageBuilder.GetError() == CHIP_NO_ERROR);
}
...
void ParseTimedRequestMessage(chip::TLV::TLVReader & aReader)
{
    ...
    EXPECT_TRUE(timeout == 1 && err == CHIP_NO_ERROR);

    EXPECT_TRUE(timedRequestMessageParser.ExitContainer() == CHIP_NO_ERROR);
}

TEST_F(TestMessageDef, DataVersionFilterIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, DataVersionFilterIBsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, EventFilterTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, EventFiltersTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, ClusterPathIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, AttributePathTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, AttributePathListTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, EventPathTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    EventPathIB::Parser eventPathParser;
...
TEST_F(TestMessageDef, EventPathsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, CommandPathIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, EventDataIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, EventReportIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, EventReportsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, EmptyEventReportsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
    ...
    EXPECT_TRUE(eventReportsBuilder.GetError() == CHIP_NO_ERROR);
    chip::System::PacketBufferHandle buf;
    err = writer.Finalize(&buf);
    EXPECT_TRUE(err == CHIP_NO_ERROR);
...
TEST_F(TestMessageDef, AttributeReportIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, AttributeReportIBsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, EmptyAttributeReportIBsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, StatusIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, EventStatusIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, AttributeStatusIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, AttributeStatusesTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, AttributeDataIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, AttributeDataIBsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, CommandDataIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, CommandStatusIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, InvokeResponseIBWithCommandDataIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
...
TEST_F(TestMessageDef, InvokeResponseIBWithCommandStatusIBTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    InvokeResponseIB::Builder invokeResponseIBBuilder;
    InvokeResponseIB::Parser invokeResponseIBParser;
...
TEST_F(TestMessageDef, InvokeResponseIBWithMalformDataTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    InvokeResponseIB::Builder invokeResponseIBBuilder;
    InvokeResponseIB::Parser invokeResponseIBParser;
...
TEST_F(TestMessageDef, InvokeRequestsTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, InvokeResponsesTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, InvokeInvokeRequestMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, InvokeInvokeResponseMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, ReportDataMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, ReadRequestMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, WriteRequestMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, WriteResponseMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, SubscribeRequestMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, SubscribeResponseMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, TimedRequestMessageTest)
{
    CHIP_ERROR err = CHIP_NO_ERROR;
    chip::System::PacketBufferTLVWriter writer;
    chip::System::PacketBufferTLVReader reader;
...
TEST_F(TestMessageDef, CheckPointRollbackTest)
{
    CHIP_ERROR err        = CHIP_NO_ERROR;
    ...
    EXPECT_TRUE(attributeDataIBsBuilder.GetError() == CHIP_NO_ERROR);
