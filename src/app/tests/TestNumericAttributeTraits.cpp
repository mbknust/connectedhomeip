...
TEST(TestNumericAttributeTraits, Test_UINT8)
{
    ...
    EXPECT_TRUE(sizeof(sValue) == 1);
    EXPECT_TRUE(sizeof(wValue) >= 1);
    ...
    EXPECT_TRUE(memcmp(&storageTestData, &sNewValue, sizeof(sNewValue)) == 0);

    // Set Storage value to Null
    IntType::SetNull(sNullValue);
    wNullValue = IntType::StorageToWorking(sNullValue);
    EXPECT_TRUE(wNullValue == workingTestUnsignedNullValue);
...
TEST(TestNumericAttributeTraits, Test_SimpleEnum)
{
    ...
    // 2) Verify that the correct storage format has been used
    EXPECT_TRUE(wValue == SimpleEnum::kOne);
...
TEST(TestNumericAttributeTraits, Test_UINT24_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValue) == 3);
    EXPECT_TRUE(sizeof(wValue) >= 3);
...
TEST(TestNumericAttributeTraits, Test_SINT24_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValuePos) == 3);
    EXPECT_TRUE(sizeof(wValuePos) >= 3);
    EXPECT_TRUE(sizeof(sValueNeg) == 3);
    EXPECT_TRUE(sizeof(wValueNeg) >= 3);
    ...
    // 2) Verify that the correct storage format has been used
    EXPECT_TRUE(wValuePos == workingDataPos);
    EXPECT_TRUE(wValueNeg == workingDataNeg);
    ...
    // 3) Verify that the bytes are located as intended
    EXPECT_TRUE(memcmp(storageTestDataPos, &sNewValuePos, sizeof(sNewValuePos)) == 0);
    EXPECT_TRUE(memcmp(storageTestDataNeg, &sNewValueNeg, sizeof(sNewValueNeg)) == 0);
    ...
    IntType::SetNull(sNullValue);
    wNullValue = IntType::StorageToWorking(sNullValue);
    EXPECT_TRUE(wNullValue == workingTestSignedNullValue);
    EXPECT_TRUE((IntType::IsNullValue(sNullValue) == true));
...
TEST(TestNumericAttributeTraits, Test_UINT40_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValue) == 5);
    EXPECT_TRUE(sizeof(wValue) >= 5);
    ...
    // 2) Verify that the correct storage format has been used
    EXPECT_TRUE(wValue == 0x123456789A);
...
TEST(TestNumericAttributeTraits, Test_SINT40_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValuePos) == 5);
    EXPECT_TRUE(sizeof(wValuePos) >= 5);
    EXPECT_TRUE(sizeof(sValueNeg) == 5);
    EXPECT_TRUE(sizeof(wValueNeg) >= 5);
...
TEST(TestNumericAttributeTraits, Test_UINT48_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValue) == 6);
    EXPECT_TRUE(sizeof(wValue) >= 6);
    ...
    // 2) Verify that the correct storage format has been used
    EXPECT_TRUE(wValue == 0x123456789ABC);
...
TEST(TestNumericAttributeTraits, Test_SINT48_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValuePos) == 6);
    EXPECT_TRUE(sizeof(wValuePos) >= 6);
    EXPECT_TRUE(sizeof(sValueNeg) == 6);
    EXPECT_TRUE(sizeof(wValueNeg) >= 6);
...
TEST(TestNumericAttributeTraits, Test_UINT56_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValue) == 7);
    EXPECT_TRUE(sizeof(wValue) >= 7);
    ...
    // 2) Verify that the correct storage format has been used
    EXPECT_TRUE(wValue == 0x123456789ABCDE);
...
TEST(TestNumericAttributeTraits, Test_SINT56_LE)
{
    ...
    // 1) Verify the size of the types
    EXPECT_TRUE(sizeof(sValuePos) == 7);
    EXPECT_TRUE(sizeof(wValuePos) >= 7);
    EXPECT_TRUE(sizeof(sValueNeg) == 7);
    EXPECT_TRUE(sizeof(wValueNeg) >= 7);
