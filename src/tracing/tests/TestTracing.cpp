...
TEST(TestTracing, TestBasicTracing)
{
    ...
    EXPECT_TRUE(backend.traces().size() == expected.size());
...
TEST(TestTracing, TestMultipleBackends)
{
    ...
    EXPECT_TRUE(b1.traces().size() == expected1.size());
    ...
    EXPECT_TRUE(b2.traces().size() == expected2.size());
    ...
    EXPECT_TRUE(b3.traces().size() == expected3.size());
