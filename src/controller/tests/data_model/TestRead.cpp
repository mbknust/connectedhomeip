...
public:
    ...
    static void TestReadAttributeResponse();
    static void TestReadAttributeError();
    static void TestReadAttributeTimeout();
    static void TestSubscribeAttributeTimeout();
    static void TestResubscribeAttributeTimeout();
    static void TestReadEventResponse();
    static void TestReadFabricScopedWithoutFabricFilter();
    static void TestReadFabricScopedWithFabricFilter();
    static void TestReadHandler_MultipleSubscriptions();
    static void TestReadHandler_SubscriptionAppRejection();
    static void TestReadHandler_MultipleReads();
    static void TestReadHandler_OneSubscribeMultipleReads();
    static void TestReadHandler_TwoSubscribesMultipleReads();
    static void TestReadHandler_MultipleSubscriptionsWithDataVersionFilter();
    static void TestReadHandler_SubscriptionReportingIntervalsTest1();
    static void TestReadHandler_SubscriptionReportingIntervalsTest2();
    static void TestReadHandler_SubscriptionReportingIntervalsTest3();
    static void TestReadHandler_SubscriptionReportingIntervalsTest4();
    static void TestReadHandler_SubscriptionReportingIntervalsTest5();
    static void TestReadHandler_SubscriptionReportingIntervalsTest6();
    static void TestReadHandler_SubscriptionReportingIntervalsTest7();
    static void TestReadHandler_SubscriptionReportingIntervalsTest8();
    static void TestReadHandler_SubscriptionReportingIntervalsTest9();
    static void TestReadHandlerResourceExhaustion_MultipleReads();
    static void TestReadSubscribeAttributeResponseWithCache();
    static void TestReadSubscribeAttributeResponseWithVersionOnlyCache();
    static void TestReadHandler_KillOverQuotaSubscriptions();
    static void TestReadHandler_KillOldestSubscriptions();
    static void TestReadHandler_ParallelReads();
    static void TestReadHandler_TooManyPaths();
    static void TestReadHandler_TwoParallelReadsSecondTooManyPaths();
    static void TestReadAttribute_ManyDataValues();
    static void TestReadAttribute_ManyDataValuesWrongPath();
    static void TestReadAttribute_ManyErrors();
    static void TestSubscribeAttributeDeniedNotExistPath();
    static void TestReadHandler_KeepSubscriptionTest();
...
private:
    ...
    // succeed.
    static void MultipleReadHelper(TestContext & aCtx, size_t aReadCount);

    // Helper for MultipleReadHelper that does not spin the event loop, so we
    // don't end up with nested event loops.
    static void MultipleReadHelperInternal(TestContext & aCtx, size_t aReadCount, uint32_t & aNumSuccessCalls,
    ...
    static void SubscribeThenReadHelper(TestContext & aCtx, size_t aSubscribeCount, size_t aReadCount);
...
TestContext TestReadInteractionBase::ctx;

uint16_t TestReadInteractionBase::mMaxInterval = 66;

TestReadInteractionBase gTestReadInteractionBase;

class TestReadInteraction : public TestReadInteractionBase, public ::testing::Test
{
public:
...
#define STATIC_TEST(test_fixture, class_name, test_name)                                                                           \
    TEST_F(test_fixture, test_name) { class_name::test_name(); }                                                                   \
    void class_name::test_name()
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadAttributeResponse)
{
    ...
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadClients() == 0);
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers() == 0);
    EXPECT_TRUE(ctx.GetExchangeManager().GetNumActiveExchanges() == 0);
}

STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadEventResponse)
{
    auto sessionHandle      = ctx.GetSessionBobToAlice();
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadAttributeError)
{
    auto sessionHandle      = ctx.GetSessionBobToAlice();
    bool onSuccessCbInvoked = false, onFailureCbInvoked = false;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadFabricScopedWithoutFabricFilter)
{
    /**
    ...
    auto onSuccessCb = [&onSuccessCbInvoked](const app::ConcreteDataAttributePath & attributePath, const auto & dataResponse) {
        ...
        EXPECT_TRUE(dataResponse.ComputeSize(&len) == CHIP_NO_ERROR);
        EXPECT_TRUE(len > 1);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadFabricScopedWithFabricFilter)
{
    /**
     *  TODO: we cannot implement the e2e read tests w/ fabric filter since the test session has only one session, and the
     * ReadSingleClusterData is not the one in real applications. We should be able to move some logic out of the ember library and
    ...
    auto onSuccessCb = [&onSuccessCbInvoked](const app::ConcreteDataAttributePath & attributePath, const auto & dataResponse) {
        ...
        {
            auto & item = iter.GetValue();
            EXPECT_TRUE(item.fabricIndex == 1);
        }
        */
        onSuccessCbInvoked = true;
    };
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_MultipleSubscriptions)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    ...
    // callbacks.
    //
    app::InteractionModelEngine::GetInstance()->RegisterReadHandlerAppCallback(&gTestReadInteractionBase);
    ...
    {
        EXPECT_TRUE(Controller::SubscribeAttribute<Clusters::UnitTesting::Attributes::ListStructOctetString::TypeInfo>(
    ...
    EXPECT_TRUE(numSuccessCalls == (app::InteractionModelEngine::kReadHandlerPoolSize + 1));
    EXPECT_TRUE(numSubscriptionEstablishedCalls == (app::InteractionModelEngine::kReadHandlerPoolSize + 1));
    EXPECT_TRUE(gTestReadInteractionBase.mNumActiveSubscriptions == (app::InteractionModelEngine::kReadHandlerPoolSize + 1));

    app::InteractionModelEngine::GetInstance()->ShutdownActiveReads();

    EXPECT_TRUE(gTestReadInteractionBase.mNumActiveSubscriptions == 0);
    EXPECT_TRUE(ctx.GetExchangeManager().GetNumActiveExchanges() == 0);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionAppRejection)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    ...
    //
    gTestReadInteractionBase.mEmitSubscriptionError = true;
    ...
    app::InteractionModelEngine::GetInstance()->UnregisterReadHandlerAppCallback();
    gTestReadInteractionBase.mEmitSubscriptionError = false;
}

void TestReadInteractionBase::SubscribeThenReadHelper(TestContext & aCtx, size_t aSubscribeCount, size_t aReadCount)
{
    ...
    auto onSubscriptionEstablishedCb = [&numSubscriptionEstablishedCalls, &aCtx, aSubscribeCount, aReadCount, &numReadSuccessCalls,
                                        &numReadFailureCalls](const app::ReadClient & readClient,
                                                              chip::SubscriptionId aSubscriptionId) {
        numSubscriptionEstablishedCalls++;
        if (numSubscriptionEstablishedCalls == aSubscribeCount)
        {
            MultipleReadHelperInternal(aCtx, aReadCount, numReadSuccessCalls, numReadFailureCalls);
        }
    };
    ...
    EXPECT_TRUE(numSuccessCalls == aSubscribeCount);
    EXPECT_TRUE(numSubscriptionEstablishedCalls == aSubscribeCount);
    EXPECT_TRUE(numReadSuccessCalls == aReadCount);
    EXPECT_TRUE(numReadFailureCalls == 0);
}
...
void TestReadInteractionBase::MultipleReadHelperInternal(TestContext & aCtx, size_t aReadCount, uint32_t & aNumSuccessCalls,
                                                         uint32_t & aNumFailureCalls)
{
    EXPECT_TRUE(aNumSuccessCalls == 0);
    EXPECT_TRUE(aNumFailureCalls == 0);
    ...
    for (size_t i = 0; i < aReadCount; ++i)
    {
        auto onSuccessCb = [&aNumSuccessCalls, firstExpectedResponse, i](const app::ConcreteDataAttributePath & attributePath,
            ...
            EXPECT_TRUE(dataResponse == firstExpectedResponse + i);
            aNumSuccessCalls++;
        };

        EXPECT_TRUE(Controller::ReadAttribute<Clusters::UnitTesting::Attributes::Int16u::TypeInfo>(
                        &aCtx.GetExchangeManager(), sessionHandle, kTestEndpointId, onSuccessCb, onFailureCb) == CHIP_NO_ERROR);
    }
}

void TestReadInteractionBase::MultipleReadHelper(TestContext & aCtx, size_t aReadCount)
{
    uint32_t numSuccessCalls = 0;
    uint32_t numFailureCalls = 0;

    MultipleReadHelperInternal(aCtx, aReadCount, numSuccessCalls, numFailureCalls);

    aCtx.DrainAndServiceIO();

    EXPECT_TRUE(numSuccessCalls == aReadCount);
    EXPECT_TRUE(numFailureCalls == 0);
}

STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_MultipleSubscriptionsWithDataVersionFilter)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numSubscriptionEstablishedCalls = 0;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_MultipleReads)
{
    ...
    MultipleReadHelper(ctx, CHIP_IM_MAX_REPORTS_IN_FLIGHT);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_OneSubscribeMultipleReads)
{
    static_assert(CHIP_IM_MAX_REPORTS_IN_FLIGHT <= app::InteractionModelEngine::kReadHandlerPoolSize,
                  "How can we have more reports in flight than read handlers?");
    static_assert(CHIP_IM_MAX_REPORTS_IN_FLIGHT > 1, "We won't do any reads");

    SubscribeThenReadHelper(ctx, 1, CHIP_IM_MAX_REPORTS_IN_FLIGHT - 1);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_TwoSubscribesMultipleReads)
{
    static_assert(CHIP_IM_MAX_REPORTS_IN_FLIGHT <= app::InteractionModelEngine::kReadHandlerPoolSize,
                  "How can we have more reports in flight than read handlers?");
    static_assert(CHIP_IM_MAX_REPORTS_IN_FLIGHT > 2, "We won't do any reads");

    SubscribeThenReadHelper(ctx, 2, CHIP_IM_MAX_REPORTS_IN_FLIGHT - 2);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandlerResourceExhaustion_MultipleReads)
{
    auto sessionHandle       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls = 0;
    uint32_t numFailureCalls = 0;
    ...
    auto onFailureCb = [&numFailureCalls](const app::ConcreteDataAttributePath * attributePath, CHIP_ERROR aError) {
        ...
        EXPECT_TRUE(aError == CHIP_IM_GLOBAL_STATUS(Busy));
        EXPECT_TRUE(attributePath == nullptr);
    };
    ...
    EXPECT_TRUE(Controller::ReadAttribute<Clusters::UnitTesting::Attributes::ListStructOctetString::TypeInfo>(
    ...
    EXPECT_TRUE(numSuccessCalls == 0);
    EXPECT_TRUE(numFailureCalls == 1);

    EXPECT_TRUE(ctx.GetExchangeManager().GetNumActiveExchanges() == 0);
}

STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadAttributeTimeout)
{
    auto sessionHandle      = ctx.GetSessionBobToAlice();
    bool onSuccessCbInvoked = false, onFailureCbInvoked = false;
    ...
    // not safe to do so.
    auto onFailureCb = [&onFailureCbInvoked](const app::ConcreteDataAttributePath * attributePath, CHIP_ERROR aError) {
        EXPECT_TRUE(aError == CHIP_ERROR_TIMEOUT);
        onFailureCbInvoked = true;
    };
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest1)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
    ...
    auto onSubscriptionEstablishedCb = [&numSubscriptionEstablishedCalls](const app::ReadClient & readClient,
        ...
        EXPECT_TRUE(minInterval == 5);
        EXPECT_TRUE(maxInterval == 5);
    ...
    //
    gTestReadInteractionBase.mAlterSubscriptionIntervals = false;
    ...
    EXPECT_TRUE(numSuccessCalls != 0);
    EXPECT_TRUE(numFailureCalls == 0);
    EXPECT_TRUE(numSubscriptionEstablishedCalls == 1);
    EXPECT_TRUE(gTestReadInteractionBase.mNumActiveSubscriptions == 1);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest2)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
    ...
    auto onSubscriptionEstablishedCb = [&numSubscriptionEstablishedCalls](const app::ReadClient & readClient,
        ...
        EXPECT_TRUE(minInterval == 0);
        EXPECT_TRUE(maxInterval == 10);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest3)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
    ...
    // Test the server-side application altering the subscription intervals.
    //
    gTestReadInteractionBase.mAlterSubscriptionIntervals = true;
    gTestReadInteractionBase.mMaxInterval                = 3000;
    EXPECT_TRUE(Controller::SubscribeAttribute<Clusters::UnitTesting::Attributes::ListStructOctetString::TypeInfo>(
                    &ctx.GetExchangeManager(), sessionHandle, kTestEndpointId, onSuccessCb, onFailureCb, 0, 10,
                    onSubscriptionEstablishedCb, nullptr, true) == CHIP_NO_ERROR);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest4)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
    ...
    //
    gTestReadInteractionBase.mAlterSubscriptionIntervals = true;
    gTestReadInteractionBase.mMaxInterval                = 3700;
    EXPECT_TRUE(Controller::SubscribeAttribute<Clusters::UnitTesting::Attributes::ListStructOctetString::TypeInfo>(
                    &ctx.GetExchangeManager(), sessionHandle, kTestEndpointId, onSuccessCb, onFailureCb, 0, 10,
                    onSubscriptionEstablishedCb, nullptr, true) == CHIP_NO_ERROR);
...
// With no server adjustment.
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest5)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest6)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest7)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest8)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
    ...
    //
    gTestReadInteractionBase.mAlterSubscriptionIntervals = true;
    gTestReadInteractionBase.mMaxInterval                = 4100;
    EXPECT_TRUE(Controller::SubscribeAttribute<Clusters::UnitTesting::Attributes::ListStructOctetString::TypeInfo>(
                    &ctx.GetExchangeManager(), sessionHandle, kTestEndpointId, onSuccessCb, onFailureCb, 0, 4000,
                    onSubscriptionEstablishedCb, nullptr, true) == CHIP_NO_ERROR);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_SubscriptionReportingIntervalsTest9)
{
    auto sessionHandle                       = ctx.GetSessionBobToAlice();
    uint32_t numSuccessCalls                 = 0;
    uint32_t numFailureCalls                 = 0;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadSubscribeAttributeResponseWithVersionOnlyCache)
{
    ...
    // read of E2C2A* and E3C2A2. Expect cache E2C2 version
    {
        ...
        EXPECT_TRUE(delegate.mNumAttributeResponse == 6);
        ...
        EXPECT_TRUE(cache.GetVersion(clusterPath1, version1) == CHIP_NO_ERROR);
        ...
        EXPECT_TRUE(cache.GetVersion(clusterPath2, version2) == CHIP_NO_ERROR);
        EXPECT_TRUE(!version2.HasValue());

        {
            ...
            EXPECT_TRUE(cache.Get(attributePath, reader) != CHIP_NO_ERROR);
        }
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadSubscribeAttributeResponseWithCache)
{
    CHIP_ERROR err    = CHIP_NO_ERROR;
    responseDirective = kSendDataResponse;
    ...
    // Expect no versions would be cached.
    {
        ...
        ctx.DrainAndServiceIO();
        EXPECT_TRUE(delegate.mNumAttributeResponse == 3);
        EXPECT_TRUE(!delegate.mReadError);
        Optional<DataVersion> version1;
        app::ConcreteClusterPath clusterPath1(chip::Test::kMockEndpoint2, chip::Test::MockClusterId(3));
        EXPECT_TRUE(cache.GetVersion(clusterPath1, version1) == CHIP_NO_ERROR);
...

        {
            ...
            EXPECT_TRUE(receivedAttribute1 == expectedAttribute1);
        }

        {
            ...
            EXPECT_TRUE(receivedAttribute2 == expectedAttribute2);
        }
    ...
    // previous test. Expect cache E2C2 version
    {
...

        {
            ...
            EXPECT_TRUE(receivedAttribute3 == expectedAttribute3);
        }
    ...
    // changed in server. Expect E1C2A* and C2C3A* and E2C2A* attributes in report, and cache their versions
    {
        ...
        EXPECT_TRUE(delegate.mNumAttributeResponse == 12);
        EXPECT_TRUE(!delegate.mReadError);
        Optional<DataVersion> version1;
        app::ConcreteClusterPath clusterPath1(chip::Test::kMockEndpoint2, chip::Test::MockClusterId(3));
        EXPECT_TRUE(cache.GetVersion(clusterPath1, version1) == CHIP_NO_ERROR);
        ...
        EXPECT_TRUE(cache.GetVersion(clusterPath3, version3) == CHIP_NO_ERROR);
    ...
    // filter with only C3. Expect E1C2A*, E2C2A* attributes(7 attributes) in report,
    {
        ...
        ctx.DrainAndServiceIO();
        EXPECT_TRUE(delegate.mNumAttributeResponse == 7);
        EXPECT_TRUE(!delegate.mReadError);
        Optional<DataVersion> version1;
        app::ConcreteClusterPath clusterPath1(chip::Test::kMockEndpoint2, chip::Test::MockClusterId(3));
        EXPECT_TRUE(cache.GetVersion(clusterPath1, version1) == CHIP_NO_ERROR);
    ...
    // since previous read does not cache any committed data version for E3C2, and expect to cache E3C2's version
    {
        ...
        EXPECT_TRUE(cache.GetVersion(clusterPath, version1) == CHIP_NO_ERROR);
        EXPECT_TRUE(version1.HasValue());
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_KillOverQuotaSubscriptions)
{
    ...
    EstablishReadOrSubscriptions(ctx.GetSessionAliceToBob(), 1, 1,
    ...
    EstablishReadOrSubscriptions(ctx.GetSessionBobToAlice(), 1, 1,
                                 app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, kPerpetualAttributeid),
                                 app::ReadClient::InteractionType::Read, &perpetualReadCallback, readClients);
    ...
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers(app::ReadHandler::InteractionType::Read) == 2);
    ...
    EstablishReadOrSubscriptions(
        ctx.GetSessionBobToAlice(), 1, app::InteractionModelEngine::kMinSupportedPathsPerSubscription + 1,
    ...
    // Subscription B
    EstablishReadOrSubscriptions(
        ctx.GetSessionBobToAlice(), kExpectedParallelSubs, app::InteractionModelEngine::kMinSupportedPathsPerSubscription,
        app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, Clusters::UnitTesting::Attributes::Int16u::Id),
        app::ReadClient::InteractionType::Subscribe, &readCallback, readClients);
    ...
    EXPECT_TRUE(readCallback.mAttributeCount ==
                kExpectedParallelSubs * app::InteractionModelEngine::kMinSupportedPathsPerSubscription +
                    app::InteractionModelEngine::kMinSupportedPathsPerSubscription + 1);
    EXPECT_TRUE(readCallback.mOnSubscriptionEstablishedCount == kExpectedParallelSubs + 1);
    ...
    // Rejection of the subscription that exceeds minimas.
    {
        ...
        EXPECT_TRUE(callback.mOnError == 1);
        EXPECT_TRUE(callback.mLastError == CHIP_IM_GLOBAL_STATUS(PathsExhausted));
    }
    ...
    {
        EstablishReadOrSubscriptions(
            ctx.GetSessionBobToAlice(), 1, app::InteractionModelEngine::kMinSupportedPathsPerSubscription,
            app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, Clusters::UnitTesting::Attributes::Int16u::Id),
            app::ReadClient::InteractionType::Subscribe, &readCallback, readClients);
        ...
        EXPECT_TRUE(readCallback.mOnSubscriptionEstablishedCount == 1);
        EXPECT_TRUE(readCallback.mAttributeCount == app::InteractionModelEngine::kMinSupportedPathsPerSubscription);
    }
    ...
    EXPECT_TRUE(readCallback.mAttributeCount == kExpectedParallelPaths);
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers(
    ...
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers(app::ReadHandler::InteractionType::Subscribe,
                                                                                     ctx.GetAliceFabricIndex()) >
    ...
    {
        EstablishReadOrSubscriptions(
            ctx.GetSessionAliceToBob(), app::InteractionModelEngine::kMinSupportedSubscriptionsPerFabric,
        ...
        EXPECT_TRUE(readCallbackFabric2.mOnSubscriptionEstablishedCount ==
                    app::InteractionModelEngine::kMinSupportedSubscriptionsPerFabric);
        EXPECT_TRUE(readCallbackFabric2.mAttributeCount ==
                    app::InteractionModelEngine::kMinSupportedPathsPerSubscription *
                        app::InteractionModelEngine::kMinSupportedSubscriptionsPerFabric);
    }
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_KillOldestSubscriptions)
{
    using namespace SubscriptionPathQuotaHelpers;
    auto sessionHandle = ctx.GetSessionBobToAlice();
    ...
    EXPECT_TRUE(readCallback.mAttributeCount ==
                kExpectedParallelSubs * app::InteractionModelEngine::kMinSupportedPathsPerSubscription);
    EXPECT_TRUE(readCallback.mOnSubscriptionEstablishedCount == kExpectedParallelSubs);
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers() == kExpectedParallelSubs);
...
static void TestReadHandler_ParallelReads_TestCase(const TestReadHandler_ParallelReads_TestCase_Parameters & params,
                                                   std::function<void()> body)
{
    auto & ctx = TestReadInteraction::ctx;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_ParallelReads)
{
    // Note: We cannot use ctx.DrainAndServiceIO() except at the end of each test case since the perpetual read transactions will
    // never end.
    // Note: We use ctx.GetIOContext().DriveIOUntil(System::Clock::Seconds16(5), [&]() { CONDITION }); and EXPECT_TRUE(// CONDITION
    // ) to ensure the CONDITION is satisfied.
    using namespace SubscriptionPathQuotaHelpers;
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(ctx.GetSessionBobToAlice(), 1,
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionAliceToBob(), 1, app::InteractionModelEngine::kMinSupportedPathsPerReadRequest + 1,
                app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, Clusters::UnitTesting::Attributes::Int16u::Id),
            ...
            EXPECT_TRUE(readCallback.mOnError != 0);
            EXPECT_TRUE(readCallback.mLastError == CHIP_IM_GLOBAL_STATUS(PathsExhausted));
        });
    ...
    TestCase(
        ...
        [&]() {
            ...
            // The new read request should be rejected
            EXPECT_TRUE(readCallback.mOnError != 0);
            EXPECT_TRUE(readCallback.mLastError == CHIP_IM_GLOBAL_STATUS(Busy));
        });
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(ctx.GetSessionBobToAlice(), 1,
                                         ...
                                         app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1),
                                         app::ReadClient::InteractionType::Read, &backgroundReadCallback1, readClients);
            EstablishReadOrSubscriptions(ctx.GetSessionAliceToBob(), 1,
                                         app::InteractionModelEngine::kMinSupportedPathsPerReadRequest,
                                         app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1),
                                         app::ReadClient::InteractionType::Read, &backgroundReadCallback2, readClients);
            ...
            EXPECT_TRUE(readCallback.mAttributeCount == app::InteractionModelEngine::kMinSupportedPathsPerReadRequest + 1);
            EXPECT_TRUE(readCallback.mOnError == 0);
    ...
    TestCase(
        ...
        [&]() {
            ...
            // The new read request should be accepted
            EXPECT_TRUE(readCallback.mAttributeCount == 1);
            EXPECT_TRUE(readCallback.mOnError == 0);
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionAliceToBob(), 1, app::InteractionModelEngine::kMinSupportedPathsPerReadRequest,
                app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, Clusters::UnitTesting::Attributes::Int16u::Id),
                app::ReadClient::InteractionType::Read, &readCallback, readClients);
            ...
            // The new read request should be accepted.
            EXPECT_TRUE(readCallback.mOnError == 0);
            EXPECT_TRUE(readCallback.mOnDone == 1);
            EXPECT_TRUE(readCallback.mAttributeCount == app::InteractionModelEngine::kMinSupportedPathsPerReadRequest);

            // The oversized read handler should be evicted -> We should have one active read handler.
            EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers() == 1);
            ...
            EXPECT_TRUE(backgroundReadCallback.reportsReceived > 0);
        });
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionBobToAlice(), 1, app::InteractionModelEngine::kMinSupportedPathsPerReadRequest,
                app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, Clusters::UnitTesting::Attributes::Int16u::Id),
                app::ReadClient::InteractionType::Read, &readCallback, readClients);
    ...
    TestCase(
        ...
        [&]() {
            ...
            ctx.GetIOContext().DriveIOUntil(System::Clock::Seconds16(5),
                                            [&]() { return backgroundReadCallback1.reportsReceived > 0; });
            EXPECT_TRUE(backgroundReadCallback1.reportsReceived > 0);
        });
    ...
    TestCase(
        ...
        [&]() {
            ...
            ctx.GetIOContext().DriveIOUntil(System::Clock::Seconds16(5),
                                            [&]() { return backgroundReadCallback2.reportsReceived > 0; });
            EXPECT_TRUE(backgroundReadCallback2.reportsReceived > 0);
        });
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionCharlieToDavid(), 1, app::InteractionModelEngine::kMinSupportedPathsPerReadRequest,
                app::AttributePathParams(kTestEndpointId, Clusters::UnitTesting::Id, Clusters::UnitTesting::Attributes::Int16u::Id),
                app::ReadClient::InteractionType::Read, &readCallback, readClients);
    ...
    TestCase(
        ...
        [&]() {
            ...
            // The new read request should be rejected.
            EXPECT_TRUE(readCallback.mOnError == 1);
            EXPECT_TRUE(readCallback.mLastError == CHIP_IM_GLOBAL_STATUS(Busy));
            // Should evict one read request from Bob fabric for enough resources.
            EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers(
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(ctx.GetSessionCharlieToDavid(), 1, 1,
                                         app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1),
                                         app::ReadClient::InteractionType::Read, &backgroundReadCallback1, readClients);
            EstablishReadOrSubscriptions(ctx.GetSessionAliceToBob(), 1, 1,
                                         app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1),
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionCharlieToDavid(), 1, 1, app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1),
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionCharlieToDavid(), 3, app::InteractionModelEngine::kMinSupportedPathsPerReadRequest - 1,
            ...
            EstablishReadOrSubscriptions(ctx.GetSessionBobToAlice(), 3,
                                         app::InteractionModelEngine::kMinSupportedPathsPerReadRequest + 1,
                                         app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1),
                                         app::ReadClient::InteractionType::Read, &backgroundReadCallback1, readClients);
            ctx.GetIOContext().DriveIOUntil(System::Clock::Seconds16(5), [&]() {
    ...
    TestCase(
        ...
        [&]() {
            ...
            EstablishReadOrSubscriptions(
                ctx.GetSessionCharlieToDavid(), 2, app::InteractionModelEngine::kMinSupportedPathsPerReadRequest - 1,
                app::AttributePathParams(kTestEndpointId, kPerpetualClusterId, 1), app::ReadClient::InteractionType::Read,
                &backgroundReadCallbackForPASESession, readClients);
            EstablishReadOrSubscriptions(ctx.GetSessionAliceToBob(), 1,
                                         app::InteractionModelEngine::kMinSupportedPathsPerReadRequest + 1,
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_TooManyPaths)
{
    using namespace chip::app;
...

    {
        ...
        EXPECT_TRUE(status.mStatus == Protocols::InteractionModel::Status::PathsExhausted);
    }
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_TwoParallelReadsSecondTooManyPaths)
{
    using namespace chip::app;
...

    {
        ...
        EXPECT_TRUE(delegate1.mNumAttributeResponse == 0);
        EXPECT_TRUE(!delegate1.mReadError);
        ...
        EXPECT_TRUE(delegate2.mNumAttributeResponse == 0);
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadAttribute_ManyDataValues)
{
    auto sessionHandle  = ctx.GetSessionBobToAlice();
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadAttribute_ManyDataValuesWrongPath)
{
    auto sessionHandle  = ctx.GetSessionBobToAlice();
    size_t successCalls = 0;
    size_t failureCalls = 0;
    ...
    EXPECT_TRUE(failureCalls == 1);
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadClients() == 0);
    EXPECT_TRUE(app::InteractionModelEngine::GetInstance()->GetNumActiveReadHandlers() == 0);
    EXPECT_TRUE(ctx.GetExchangeManager().GetNumActiveExchanges() == 0);
}

STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadAttribute_ManyErrors)
{
    auto sessionHandle  = ctx.GetSessionBobToAlice();
    size_t successCalls = 0;
    size_t failureCalls = 0;
...
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestSubscribeAttributeDeniedNotExistPath)
{
    auto sessionHandle = ctx.GetSessionBobToAlice();
...

    {
        ...
        EXPECT_TRUE(callback.mOnError == 1);
        EXPECT_TRUE(callback.mLastError == CHIP_IM_GLOBAL_STATUS(InvalidAction));
        EXPECT_TRUE(callback.mOnDone == 1);
    }
...
//
//
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestResubscribeAttributeTimeout)
{
    auto sessionHandle = ctx.GetSessionBobToAlice();
...

    {
        ...
        EXPECT_TRUE(callback.mOnSubscriptionEstablishedCount == 1);
        EXPECT_TRUE(callback.mOnError == 0);
        EXPECT_TRUE(callback.mOnResubscriptionsAttempted == 0);
        ...
        EXPECT_TRUE(callback.mOnResubscriptionsAttempted == 1);
        EXPECT_TRUE(callback.mLastError == CHIP_ERROR_TIMEOUT);
        ...
        //
        EXPECT_TRUE(callback.mOnError == 0);
        EXPECT_TRUE(callback.mOnDone == 0);
    }
...
//
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestSubscribeAttributeTimeout)
{
    auto sessionHandle = ctx.GetSessionBobToAlice();
...
//
STATIC_TEST(TestReadInteraction, TestReadInteractionBase, TestReadHandler_KeepSubscriptionTest)
{
    using namespace SubscriptionPathQuotaHelpers;
    ...
    std::unique_ptr<app::ReadClient> readClient = std::make_unique<app::ReadClient>(
        ...
        app::ReadClient::InteractionType::Subscribe);
    EXPECT_TRUE(readClient->SendRequest(readParam) == CHIP_NO_ERROR);
...
System::Clock::Timeout TestReadInteractionBase::ComputeSubscriptionTimeout(System::Clock::Seconds16 aMaxInterval)
{
