 ...
 */
TEST(TestInetAddress, CheckFromString)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckToString)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    char lAddressBuffer[INET6_ADDRSTRLEN];
 ...
 */
TEST(TestInetAddress, CheckIsIPv6ULA)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsIPv6ULA() == lCurrent->isIPv6ULA);
 ...
 */
TEST(TestInetAddress, CheckIsIPv6LLA)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsIPv6LinkLocal() == lCurrent->isIPv6LLA);
 ...
 */
TEST(TestInetAddress, CheckIsIPv6Multicast)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsIPv6Multicast() == lCurrent->isIPv6Multicast);
 ...
 */
TEST(TestInetAddress, CheckIsMulticast)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsMulticast() == lCurrent->isMulticast);
 ...
 */
TEST(TestInetAddress, CheckOperatorEqual)
{
    IPAddressExpandedContextIterator lFirstCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lFirstEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;

    while (lFirstCurrent != lFirstEnd)
    {
        IPAddressExpandedContextIterator lSecondCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
        IPAddressExpandedContextIterator lSecondEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
        ...
        while (lSecondCurrent != lSecondEnd)
        {
            ...
            {
                ASSERT_TRUE(test_addr_1 == test_addr_2);
            }
            else
            {
                ASSERT_TRUE(!(test_addr_1 == test_addr_2));
 ...
 */
TEST(TestInetAddress, CheckOperatorNotEqual)
{
    IPAddressExpandedContextIterator lFirstCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lFirstEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckOperatorAssign)
{
    IPAddressExpandedContextIterator lFirstCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lFirstEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckToIPv6)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(!memcmp(&ip_addr_1, &ip_addr_2, sizeof(ip_addr_1)));
 ...
 */
TEST(TestInetAddress, CheckFromIPv6)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckIsIPv4)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsIPv4() == lCurrent->isIPv4);
 ...
 */
TEST(TestInetAddress, CheckIsIPv4Multicast)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsIPv4Multicast() == lCurrent->isIPv4Multicast);
 ...
 */
TEST(TestInetAddress, CheckIsIPv4Broadcast)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.IsIPv4Broadcast() == lCurrent->isIPv4Broadcast);
 ...
 */
TEST(TestInetAddress, CheckToIPv4)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckFromIPv4)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckFromSocket)
{
#if CHIP_SYSTEM_CONFIG_USE_LWIP
    (void) inSuite;
 ...
 */
TEST(TestInetAddress, CheckType)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.Type() == lCurrent->mAddr.mAddrType);
 ...
 */
TEST(TestInetAddress, CheckAnyAddress)
{
    const IPAddress test_addr = IPAddress::Any;
    IPAddressType test_type   = test_addr.Type();

    ASSERT_TRUE(test_type == IPAddressType::kAny);
}

/**
 *  Test IP address interface ID.
 */
TEST(TestInetAddress, CheckInterface)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.InterfaceId() == lCurrent->interface);
 ...
 */
TEST(TestInetAddress, CheckSubnet)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.Subnet() == lCurrent->subnet);
 ...
 */
TEST(TestInetAddress, CheckGlobal)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.GlobalId() == lCurrent->global);
 ...
 */
TEST(TestInetAddress, CheckEncoding)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(buffer[3] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[0]));
        ASSERT_TRUE(buffer[2] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[0] >> 8));
        ASSERT_TRUE(buffer[1] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[0] >> 16));
        ASSERT_TRUE(buffer[0] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[0] >> 24));

        ASSERT_TRUE(buffer[7] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[1]));
        ASSERT_TRUE(buffer[6] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[1] >> 8));
        ASSERT_TRUE(buffer[5] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[1] >> 16));
        ASSERT_TRUE(buffer[4] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[1] >> 24));

        ASSERT_TRUE(buffer[11] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[2]));
        ASSERT_TRUE(buffer[10] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[2] >> 8));
        ASSERT_TRUE(buffer[9] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[2] >> 16));
        ASSERT_TRUE(buffer[8] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[2] >> 24));

        ASSERT_TRUE(buffer[15] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[3]));
        ASSERT_TRUE(buffer[14] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[3] >> 8));
        ASSERT_TRUE(buffer[13] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[3] >> 16));
        ASSERT_TRUE(buffer[12] == (uint8_t)(lCurrent->mAddr.mAddrQuartets[3] >> 24));
 ...
 */
TEST(TestInetAddress, CheckDecoding)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckEcodeDecodeSymmetricity)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
 ...
 */
TEST(TestInetAddress, CheckMakeULA)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.Addr[0] == htonl(static_cast<uint32_t>(ULA_PREFIX | (lCurrent->global & ULA_UP_24_BIT_MASK) >> 16)));
        ASSERT_TRUE(test_addr.Addr[1] ==
                    htonl(static_cast<uint32_t>((lCurrent->global & ULA_LO_16_BIT_MASK) << 16 | lCurrent->subnet)));
        ASSERT_TRUE(test_addr.Addr[2] == htonl(static_cast<uint32_t>(lCurrent->interface >> 32)));
        ASSERT_TRUE(test_addr.Addr[3] == htonl(static_cast<uint32_t>(lCurrent->interface)));
 ...
 */
TEST(TestInetAddress, CheckMakeLLA)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(test_addr.Addr[0] == htonl(LLA_PREFIX));
        ASSERT_TRUE(test_addr.Addr[1] == 0);
        ASSERT_TRUE(test_addr.Addr[2] == htonl(static_cast<uint32_t>(lCurrent->interface >> 32)));
        ASSERT_TRUE(test_addr.Addr[3] == htonl(static_cast<uint32_t>(lCurrent->interface)));
...
TEST(TestInetAddress, CheckMakeIPv6WellKnownMulticast)
{
    IPAddressContextIterator lCurrent = sTestContext.mIPv6WellKnownMulticastContextRange.mBegin;
    IPAddressContextIterator lEnd     = sTestContext.mIPv6WellKnownMulticastContextRange.mEnd;
    size_t lGroupIndex;
    size_t lScopeIndex;
    IPAddress lAddress;
...
TEST(TestInetAddress, CheckMakeIPv6TransientMulticast)
{
    IPAddressContextIterator lCurrent = sTestContext.mIPv6TransientMulticastContextRange.mBegin;
    IPAddressContextIterator lEnd     = sTestContext.mIPv6TransientMulticastContextRange.mEnd;
...
TEST(TestInetAddress, CheckMakeIPv6PrefixMulticast)
{
    IPAddressContextIterator lCurrent = sTestContext.mIPv6PrefixMulticastContextRange.mBegin;
    IPAddressContextIterator lEnd     = sTestContext.mIPv6PrefixMulticastContextRange.mEnd;
 ...
 *  Test IPPrefix.
 */
TEST(TestInetAddress, CheckIPPrefix)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    size_t i                                  = 0;
    ...
    while (lCurrent != lEnd)
    {
        ...
        ASSERT_TRUE(!ipprefix_1.IsZero());
        ASSERT_TRUE(!ipprefix_2.IsZero());
        ASSERT_TRUE(ipprefix_1 == ipprefix_2);
        ASSERT_TRUE(!(ipprefix_1 != ipprefix_2));
#if !CHIP_SYSTEM_CONFIG_USE_LWIP
        ASSERT_TRUE(ipprefix_1.MatchAddress(test_addr_1));
#endif
        ++lCurrent;
    }
}
 ...
 * Test ToLwIPAddress()
 */
TEST(TestInetAddress, CheckToLwIPAddr)
{
    IPAddressExpandedContextIterator lCurrent = sTestContext.mIPAddressExpandedContextRange.mBegin;
    IPAddressExpandedContextIterator lEnd     = sTestContext.mIPAddressExpandedContextRange.mEnd;
    CHIP_ERROR err;
    ...
    while (lCurrent != lEnd)
    {
        ...
        if (lCurrent->mAddr.mAddrType == IPAddressType::kIPv4)
        {
            ...
            ASSERT_TRUE(sameLwIPAddress(lwip_expected_addr, lwip_check_addr));

            err = test_addr.ToLwIPAddr(IPAddressType::kAny, lwip_check_addr);
            ASSERT_TRUE(err == CHIP_NO_ERROR);
            ASSERT_TRUE(sameLwIPAddress(lwip_expected_addr, lwip_check_addr));
            ...
            ASSERT_TRUE(err == INET_ERROR_WRONG_ADDRESS_TYPE);
        }
        else
#endif // INET_CONFIG_ENABLE_IPV4
        ...
        {
            lwip_check_addr = test_addr.ToLwIPAddr();
            ASSERT_TRUE(sameLwIPAddress(*IP6_ADDR_ANY, lwip_check_addr));
            ...
            err = test_addr.ToLwIPAddr(IPAddressType::kIPv4, lwip_check_addr);
            ASSERT_TRUE(err == CHIP_NO_ERROR);
            ASSERT_TRUE(sameLwIPAddress(*IP4_ADDR_ANY, lwip_check_addr));
#endif // INET_CONFIG_ENABLE_IPV4
        }
